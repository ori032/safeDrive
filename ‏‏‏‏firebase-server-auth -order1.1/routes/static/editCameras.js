document.addEventListener("DOMContentLoaded", () => {
    ...
    async function drawCamerasEditButton() {
        ...
        camerasArr.forEach((cameraId) => {
            // var cameraCard = createDeleteCameraCard(cameraId);
            // mainContainer.appendChild(button);
            var onclickFunck = (async function () {
                drawSpiner();

                try {
                    var tittleTravelsArr = await postRequestToServer("/dbServer/deleteCamera", JSON.stringify({ cameraId: cameraId }));
            ...
            var deleteCameraCard = createCardWithButton(cameraId, cameraId, "Delete camera", onclickFunck, "danger");
